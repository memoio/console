...
// import companyLogo from '/public/android-icon-72x72.png';

const VersionIcon = (props: SVGProps<SVGSVGElement>) => (

  <img src="/android-icon-48x48.png" alt="">
  </img>
  /*
  <svg
